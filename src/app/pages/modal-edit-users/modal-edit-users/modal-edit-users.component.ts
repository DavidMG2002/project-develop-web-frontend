...
@Component({
  ...
  templateUrl: './modal-edit-users.component.html', // Archivo que contiene la estructura visual del componente.
  styleUrl: './modal-edit-users.component.scss' // Archivo donde se encuentran los estilos específicos del componente.
})
